...
import { followCreator, getUserByUsername, getUserDetails, login, resetPassword, saveAvailability, saveDetails, sendResetPasswordOtp, signinwithGoogle, signUp, unfollowCreator, verifyResetPasswordOtp } from "../Controllers/CreatorController.js";
...
router.route('/saveavailability').post(saveAvailability)
